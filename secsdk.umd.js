...
!(function (e, t) {
    ...
    E = {
      f: u
        ...
        : function (e, t) {
            ...
            if (S(e, t)) return l(!f.f.call(e, t), e[t]);
          },
    },
    O = function (e) {
  ...
  if (N) {
    var Y = x.state || (x.state = new $()),
      ...
      Z = Y.set;
    (I = function (e, t) {
      return (t.facade = e), Z.call(Y, e, t), t;
    }),
      (C = function (e) {
        return J.call(Y, e) || {};
      }),
  ...
  var ee = {
    ...
    de = function (e, t) {
      var n,
        ...
        o = 0,
        i = [];
      for (n in r) !S(z, n) && S(r, n) && i.push(n);
      for (; t.length > o; ) S(r, (n = t[o++])) && (~ve(i, n) || i.push(n));
      return i;
    },
    ye = [
      "constructor",
    ...
    Ne = function (e) {
      return (
        S(He, e) ||
          (Ie && S(Fe, e) ? (He[e] = Fe[e]) : (He[e] = _e("Symbol." + e))),
        He[e]
      );
    },
    Be = Ne("species"),
    ...
    Je = function (e, t) {
      ...
      return ($e[e] =
        ...
        !a(function () {
          if (r && !u) return !0;
          var e = { length: -1 };
          r ? ze(e, 1, { enumerable: !0, get: Ye }) : (e[1] = 1),
            n.call(e, o, i);
        }));
    },
    Ke = Ve.forEach,
  ...
  Te({ target: "Array", proto: !0, forced: [].forEach != et }, { forEach: et });
  var tt,
    nt =
      Object.keys ||
      function (e) {
    ...
    ct = function () {
      ...
      ct = tt
        ...
        : (((t = L("iframe")).style.display = "none"),
          ...
          e.close(),
          e.F);
      for (var n = ye.length; n--; ) delete ct.prototype[ye[n]];
      return ct();
    };
  z[it] = !0;
  var st =
    ...
    ft = Ne("unscopables"),
    lt = Array.prototype;
  null == lt[ft] && T.f(lt, ft, { configurable: !0, value: st(null) });
  var ht = function (e) {
      lt[ft][e] = !0;
    },
    pt = pe.includes,
    vt = Je("indexOf", { ACCESSORS: !0, 1: 0 });
  Te(
  ...
  var St = yt && +yt,
    ...
    At = Je("map");
  Te(
    { target: "Array", proto: !0, forced: !Lt || !At },
    {
      map: function (e) {
  ...
  var jt = Ve.some,
    ...
    Ot = Je("some");
  Te(
    { target: "Array", proto: !0, forced: !Et || !Ot },
    {
      some: function (e) {
  ...
  var Pt = Object.assign,
    ...
    qt =
      ...
      a(function () {
        ...
        ? function (e, t) {
            for (
              var n = xe(e), r = arguments.length, o = 1, i = we.f, a = f.f;
              r > o;
  ...
  xt || te(Object.prototype, "toString", Ht, { unsafe: !0 });
  var Ft = i.Promise,
    _t = function (e, t, n) {
    ...
    Dt = function (e, t, n) {
      e &&
        ...
        Nt(e, Bt, { configurable: !0, value: t });
    },
    Xt = Ne("species"),
    Gt = function (e, t, n) {
      if (!(e instanceof t))
    ...
    Yt = Ne("iterator"),
    Jt = function (e) {
      if (null != e) return e[Yt] || e["@@iterator"] || Vt[Ct(e)];
    },
    Kt = function (e) {
      var t = e.return;
    ...
    Qt = function (e, t, n) {
      ...
      if (p) o = e;
        ...
        if ($t(i)) {
          for (a = 0, u = se(e.length); u > a; a++)
            if ((c = g(e[a])) && c instanceof Zt) return c;
          return new Zt(!1);
        }
        o = i.call(e);
      }
      for (s = o.next; !(f = s.call(o)).done; ) {
        ...
        if ("object" == r(c) && c && c instanceof Zt) return c;
      }
      return new Zt(!1);
    },
    en = Ne("iterator"),
  ...
  var Ln,
    ...
    qn,
    Un = { set: pn, clear: vn },
    xn = /web0s(?!.*chrome)/i.test(gt),
    Mn = E.f,
    In = Un.set,
    Cn = i.MutationObserver || i.WebKitMutationObserver,
    Hn = i.document,
    Fn = i.process,
    _n = i.Promise,
    Nn = Mn(i, "queueMicrotask"),
    Bn = Nn && Nn.value;
  Bn ||
    ((Ln = function () {
      var e, t;
    ...
    fn || ln || xn || !Cn || !Hn
      ...
      : ((On = !0),
        ...
        new Cn(Ln).observe(Pn, { characterData: !0 }),
        (En = function () {
          Pn.data = On = !On;
        })));
  var Dn,
    ...
    hr = Oe(Qn, function () {
      ...
      if (St >= 51 && /native code/.test(rr)) return !1;
      var e = rr.resolve(1),
        t = function (e) {
          e(
            function () {},
    ...
    kr = function e(t, n, r) {
      if (!t.done) {
        (t.done = !0), r && (t = r);
        try {
          if (t.facade === n) throw or("Promise can't be resolved itself");
          var o = vr(n);
          o
            ? Wn(function () {
                var r = { done: !1 };
  ...
  hr &&
    ...
    Te({ global: !0, wrap: !0, forced: hr }, { Promise: rr }),
    Dt(rr, Qn, !1),
    (function (e) {
      var t = oe(e),
        n = T.f;
  ...
  var Rr =
    !!Ft &&
    a(function () {
      Ft.prototype.finally.call({ then: function () {} }, function () {});
    });
  Te(
    { target: "Promise", proto: !0, real: !0, forced: Rr },
    {
      finally: function (e) {
  ...
  [].keys &&
    ("next" in (jr = [].keys())
      ? (Ar = Ur(Ur(jr))) !== Object.prototype && (Lr = Ar)
      : (Mr = !0)),
    null == Lr && (Lr = {}),
    S(Lr, xr) ||
      q(Lr, xr, function () {
  ...
  var Ir = { IteratorPrototype: Lr, BUGGY_SAFARI_ITERATORS: Mr },
    ...
    Fr = function (e, t, n) {
      var r = t + " Iterator";
      return (
        (e.prototype = st(Cr, { next: l(1, n) })), Dt(e, r, !1), (Vt[r] = Hr), e
      );
    },
    _r =
    ...
    Gr = function (e, t, n, r, o, i, a) {
      ...
      if (
        ...
        if (
          ...
          for (s in c) (Br || h || !(s in p)) && te(p, s, c[s]);
        else Te({ target: t, proto: !0, forced: Br || h }, c);
      return c;
    },
    Vr = Or.charAt,
    Wr = ee.set,
  ...
  Gr(
    ...
    "String",
    function (e) {
      Wr(this, { type: "String Iterator", string: String(e), index: 0 });
    },
    function () {
      var e,
        t = zr(this),
      ...
      return r >= n.length
        ? { value: void 0, done: !0 }
        : ((e = Vr(n, r)), (t.index += e.length), { value: e, done: !1 });
    }
  );
  var $r = function (e, t) {
    var n = this;
    ...
    var r = [];
    return Qt(e, r.push, { that: r }), q(n, "errors", r), n;
  };
                ...
                o.push(void 0),
                  ...
                  n.call(t, e).then(
                    function (e) {
                      c ||
                        ((c = !0),
                        (o[u] = { status: "fulfilled", value: e }),
                        --a || r(o));
                    },
                    function (e) {
                      c ||
                        ((c = !0),
                        (o[u] = { status: "rejected", reason: e }),
                        --a || r(o));
                    }
                  );
              }),
  ...
  var Yr = {
    ...
    Zr = Gr(
      ...
      "Array",
      function (e, t) {
        Jr(this, { type: "Array Iterator", target: g(e), index: 0, kind: t });
      },
      function () {
        var e = Kr(this),
          t = e.target,
  ...
  var ao = Ne("iterator"),
    ...
    wo = function (e) {
      var t,
        ...
        a = 0,
        u = 72;
      for (t = 0; t < e.length; t++) (n = e[t]) < 128 && r.push(yo(n));
      var c = r.length,
        s = c;
      for (c && r.push("-"); s < o; ) {
        var f = 2147483647;
        for (t = 0; t < e.length; t++) (n = e[t]) >= i && n < f && (f = n);
        var l = s + 1;
        if (f - i > vo((2147483647 - a) / l)) throw RangeError(po);
        for (a += (f - i) * l, i = f, t = 0; t < e.length; t++) {
          if ((n = e[t]) < i && ++a > 2147483647) throw RangeError(po);
          if (n == i) {
    ...
    Co = function (e, t) {
      if (t)
        for (var n, r, o = t.split("&"), i = 0; i < o.length; )
          (n = o[i++]).length &&
            ((r = n.split("=")),
            e.push({ key: qo(r.shift()), value: qo(r.join("=")) }));
    },
    Ho = function (e) {
      (this.entries.length = 0), Co(this.entries, e);
    },
    Fo = function (e, t) {
    ...
    No = function () {
      ...
      if (
        ...
        if (m(s))
          ...
          else for (c in s) S(s, c) && l.push({ key: c, value: s[c] + "" });
        else
          Co(
            l,
            "string" == typeof s
    ...
    Bo,
    {
      ...
      forEach: function (e) {
        for (
          var t,
            n = Ao(this).entries,
            r = Ue(e, arguments.length > 1 ? arguments[1] : void 0, 3),
            o = 0;
          o < n.length;
    ...
    te(
      ...
      function () {
        for (var e, t = Ao(this).entries, n = [], r = 0; r < t.length; )
          (e = t[r++]), n.push(Io(e.key) + "=" + Io(e.value));
        return n.join("&");
      },
      { enumerable: !0 }
    ),
    Dt(No, "URLSearchParams"),
    Te({ global: !0, forced: !uo }, { URLSearchParams: No }),
    uo ||
      "function" != typeof So ||
      "function" != typeof ko ||
      Te(
              ...
              arguments.length > 1 &&
                (m((t = arguments[1])) &&
                  ...
                  "URLSearchParams" === Ct(n) &&
                    ...
                    (t = st(t, { body: l(0, String(n)), headers: l(0, r) })))),
                o.push(t)),
              So.apply(this, o)
            );
          },
  ...
  var Do,
    Xo = { URLSearchParams: No, getState: Ao },
    Go = Or.codeAt,
    Vo = i.URL,
    ...
    si = function (e, t) {
      ...
      if ("[" == t.charAt(0)) {
        ...
        if (!(n = li(t.slice(1, -1)))) return "Invalid host";
        e.host = n;
      } else if (wi(e)) {
        if (
          ((t = (function (e) {
          ...
          return "Invalid host";
        if (null === (n = fi(t))) return "Invalid host";
        e.host = n;
      } else {
        if (ai.test(t)) return "Invalid host";
        for (n = "", r = fo(t), o = 0; o < r.length; o++) n += gi(r[o], pi);
        e.host = n;
      }
    },
    fi = function (e) {
      ...
      for (n = [], r = 0; r < t; r++) {
        ...
        if (
          ...
          if (!(10 == i ? ri : 8 == i ? ni : oi).test(o)) return e;
          a = parseInt(o, i);
        }
        n.push(a);
      }
      ...
      for (u = n.pop(), r = 0; r < n.length; r++) u += n[r] * Ko(256, 3 - r);
      return u;
    },
    li = function (e) {
      var t,
    ...
    hi = function (e) {
      var t, n, o, i;
      if ("number" == typeof e) {
        for (t = [], n = 0; n < 4; n++) t.unshift(e % 256), (e = Jo(e / 256));
        return t.join(".");
      }
      if ("object" == r(e)) {
        for (
      ...
      for (
        ...
        switch (((i = o[f]), s)) {
          ...
          case Ui:
            ...
            break;
          case xi:
            if (((s = Mi), "/" != i || "/" != l.charAt(f + 1))) continue;
            f++;
            break;
          case Mi:
            if ("/" != i && "\\" != i) {
          ...
          case Hi:
            ...
            if (":" != i || p) {
              if (
                ...
                if (wi(e) && "" == l) return "Invalid host";
                if (n && "" == l && (bi(e) || null !== e.port)) return;
                if ((u = si(e, l))) return u;
                if (((l = ""), (s = Di), n)) return;
                continue;
              }
              "[" == i ? (p = !0) : "]" == i && (p = !1), (l += i);
          ...
          case Di:
            if (wi(e)) {
              if (((s = Xi), "/" != i && "\\" != i)) continue;
            } else if (n || "?" != i)
              if (n || "#" != i) {
                if (i != Do && ((s = Xi), "/" != i)) continue;
              } else (e.fragment = ""), (s = Wi);
            else (e.query = ""), (s = Vi);
            break;
          case Xi:
            if (
    ...
    $i = function (e) {
      var t,
        ...
        a = $o(r, { type: "URL" });
      if (void 0 !== o)
        if (o instanceof $i) t = Yo(o);
        else if ((n = zi((t = {}), String(o)))) throw TypeError(n);
      if ((n = zi(a, i, null, t))) throw TypeError(n);
  ...
  if (
    (u &&
      rt(Yi, {
        ...
        username: ca(Qi, function (e) {
          ...
          if (!Si(t)) {
            t.username = "";
            for (var r = 0; r < n.length; r++) t.username += gi(n[r], yi);
          }
        }),
        password: ca(ea, function (e) {
          ...
          if (!Si(t)) {
            t.password = "";
            for (var r = 0; r < n.length; r++) t.password += gi(n[r], yi);
          }
        }),
    ...
    sa &&
      te($i, "createObjectURL", function (e) {
        return sa.apply(Vo, arguments);
      }),
      fa &&
        te($i, "revokeObjectURL", function (e) {
          return fa.apply(Vo, arguments);
        });
  }
  Dt($i, "URL"),
    Te({ global: !0, forced: !uo, sham: !u }, { URL: $i }),
    Te(
          ...
          },
          {
            ...
            value: function () {
              ...
              return Array.isArray(t)
                ...
                : (this.tokenMap[t] ||
                    (this.tokenMap[t] = this.fetchTokenFromServer(t, n).then(
                      function (n) {
                        return (e.tokenMap[t] = n), n;
                      }
                    )),
                  Promise.resolve(this.tokenMap[t]).then(function (r) {
                    return r.expiredAt < Date.now()
            ...
            value: function (e, t) {
              ...
              return new Promise(function (r) {
                var o = new XMLHttpRequest(),
                  i = { value: "DOWNGRADE", expiredAt: Date.now() + 1e3 };
                o.addEventListener("load", function () {
                  ...
                  r({ value: t[1], expiredAt: Date.now() + a });
                }),
            ...
            value: function () {
              if (va) {
                ...
                window.fetch = function (t, n) {
                  ...
                  return e.shouldProtectRequest(a.host, o, a.pathname)
                    ? e.fetchToken(a.host, a.pathname).then(function (r) {
                        ...
                        } else n.headers[e.tokenHeaderName] = r.value;
